...
public class DateUtil1 {
	...
	public static Date getDate(String dateTimeStr, String formatStr) {
		try {
			...
			DateFormat sdf = DateUtil1.getDateFormat(formatStr);
	...
	public static Date convertDate(String dateTimeStr) {
		try {
			...
			DateFormat sdf = DateUtil1.getDateFormat(yyyy_MM_dd_EN);
	...
	public static Date transferDate(String date) throws Exception {
		...
		return DateUtil1.getDate(str, DateUtil1.yyyy_MM_dd_EN);
	}
	...
	public static String getDateOfMon(String date, int mon, String formatStr) {
		Calendar now = Calendar.getInstance(TimeZone.getDefault());
		now.setTime(DateUtil1.getDate(date, formatStr));
...
//		System.out.println(getLongToStr(getPointDateHourTime(1, 9), "yyyy-MM-dd HH:mm:ss"));
	...
	public static int getMinutest(String begin, String format){
		String nowMinutes = DateUtil1.getCurDate("HH:mm");
		long time = DateUtil1.compareDateStr("09:00", nowMinutes, "HH:mm");
		return (int) time;
	}
