...
!function (e) {
    ...
    var i, t, a, r, n, l, o, s, d, c, p, u, f, v, g, m, h, w, b, C, x, y, T, F, I, E, k, $, P, S, D, U, A, j, L, z, O,
        R, M, B, N, Z, H, W, q, _, V, K, X, J, Q, Y, G;
    G = ".fileinput", i = function (e) {
        ...
        data: {}, init: function (e) {
            ...
            var n = a.config[i], l = _("caption", n) ? n.caption : "", o = _("width", n) ? n.width : "auto",
                s = _("url", n) ? n.url : !1, d = _("key", n) ? n.key : null, c = s === !1 && t,
        ...
        constructor: Y, validate: function () {
            ...
            var i = this, t = _(e, i.layoutTemplates) ? i.layoutTemplates[e] : M[e];
            return W(i.customLayoutTags) ? t : J(t, i.customLayoutTags)
        }, getPreviewTemplate: function (e) {
            var i = this, t = _(e, i.previewTemplates) ? i.previewTemplates[e] : B[e];
            ...
            var i = this, t = i.$element, r = t.closest("form"), n = i.$container;
            a(t, "change", e.proxy(i.change, i)), a(i.$btnFile, "click", e.proxy(i.browse, i)), a(r, "reset", e.proxy(i.reset, i)), a(n.find(".fileinput-remove:not([disabled])"), "click", e.proxy(i.clear, i)), a(n.find(".fileinput-cancel"), "click", e.proxy(i.cancel, i)), i.initDragDrop(), i.isUploadable || a(r, "submit", e.proxy(i.submitForm, i)), a(i.$container.find(".fileinput-upload"), "click", e.proxy(i.uploadClick, i))
            ...
            return t.zoneDragDropInit(i), t.isDisabled || !a ? (i.originalEvent.dataTransfer.effectAllowed = "none", void(i.originalEvent.dataTransfer.dropEffect = "none")) : void d(t.$dropZone, "file-highlighted")
        }, zoneDragLeave: function (e) {
            var i = this;
            i.zoneDragDropInit(e), i.isDisabled || i.$dropZone.removeClass("file-highlighted")
        }, zoneDrop: function (e) {
            var i = this;
            e.preventDefault(), i.isDisabled || W(e.originalEvent.dataTransfer.files) || (i.change(e, "dragdrop"), i.$dropZone.removeClass("file-highlighted"))
        }, initDragDrop: function () {
            var i = this, t = i.$dropZone;
            i.isUploadable && i.dropZoneEnabled && i.showPreview && (a(t, "dragenter dragover", e.proxy(i.zoneDragEnter, i)), a(t, "dragleave", e.proxy(i.zoneDragLeave, i)), a(t, "drop", e.proxy(i.zoneDrop, i)), a(t, "dragenter dragover drop", i.zoneDragDropInit))
        }, browse: function (e) {
            var i = this;
            ...
            var i, t = this, a = t.$container.find(".fileinput-upload"),
                r = !a.hasClass("disabled") && W(a.attr("disabled"));
            ...
            i.find(".file-drop-zone").off(), e.$element.insertBefore(i).off(G).removeData(), i.off().remove()
        }, refresh: function (i) {
            ...
            var n, l, o, s, c, p, u, f, v, g, m = this, h = m.getFileStack().length, w = new FormData,
                b = m.previewInitId + "-" + i, C = m.filestack.length > 0 || !e.isEmptyObject(m.uploadExtraData), x = {
                    id: b, index: i
                };
            m.formdata = w, m.showPreview && (l = e("#" + b + ":not(.file-preview-initial)"), s = l.find(".kv-file-upload"), c = l.find(".kv-file-remove"), e("#" + b).find(".file-thumb-progress").removeClass("hide")), 0 === h || !C || s && s.hasClass("disabled") || m.abort(x) || (g = function (e, i) {
                ...
                n = m.getOutData(t), m.fileBatchCompleted = !1, m.showPreview && (l.hasClass("file-preview-success") || (m.setThumbStatus(l, "Loading"), d(l, "file-uploading")), s.attr("disabled", !0), c.attr("disabled", !0)), a || m.lock(), m.raise("filepreupload", [n, b, i]), e.extend(!0, x, n), m.abort(x) && (t.abort(), m.setProgress(100))
            }, u = function (t, r, o) {
                n = m.getOutData(o, t), e.extend(!0, x, n), setTimeout(function () {
                    W(t) || W(t.error) ? (m.showPreview && (m.setThumbStatus(l, "Success"), s.hide(), m.initUploadSuccess(t, l, a)), m.raise("fileuploaded", [n, b, i]), a ? g(i, b) : m.updateStack(i, void 0)) : (m.showUploadError(t.error, x), m.setPreviewError(l, i), a && g(i, b))
                }, 100)
            }, f = function () {
                setTimeout(function () {
                ...
                setTimeout(function () {
                    a && g(i, b), m.uploadStatus[b] = 100, m.setPreviewError(l, i), e.extend(!0, x, m.getOutData(r)), m.showUploadError(s, x)
                }, 100)
            ...
            l.formdata = new FormData, 0 !== s && p && !l.abort(c) && (n = function () {
                e.each(o, function (e) {
                ...
                var r = l.getOutData(a, i), o = l.getThumbs(), s = 0, d = W(i) || W(i.errorkeys) ? [] : i.errorkeys;
                W(i) || W(i.error) ? (l.raise("filebatchuploadsuccess", [r]), n(), l.showPreview ? (o.each(function () {
            ...
            e && t.length && (t.html(i.errorCloseButton + e), a(t.find(".kv-error-close"), "click", function () {
                t.fadeOut("slow")
            }))
            ...
            if (this.showPreview) {
                var n, l, o, s = this, d = s.parseFileType(i), c = i ? i.name : "", p = s.slug(c),
                    ...
                    g = u && u.indexOf(d) >= 0, m = _(d, s.previewSettings) ? s.previewSettings[d] : Z[d],
            ...
            return W(e) ? "" : String(e).replace(/[\-\[\]\/\{}:;#%=\(\)\*\+\?\\\^\$\|<>&"']/g, "_")
            ...
            var t, a = this, r = a.$element, n = a.$preview, l = a.reader, o = a.$previewContainer,
                ...
                f = a.fileTypeSettings, v = a.filestack.length, g = function (r, n, l, o) {
                    var s = e.extend(!0, {}, a.getOutData({}, {}, i), {id: l, index: o}),
                        d = {id: l, index: o, file: n, files: i};
                    return a.previewDefault(n, l, !0), a.isUploadable && a.addToStack(void 0), setTimeout(t(o + 1), 100), a.initFileActions(), a.removeFromPreviewOnError && e("#" + l).remove(), a.isUploadable ? a.showUploadError(r, s) : a.showError(r, d)
                };
            a.loadedImages = [], a.totalImagesCount = 0, e.each(i, function (e, i) {
                var t = a.fileTypeSettings.image || H.image;
                t && t(i.type) && a.totalImagesCount++
            }), t = function (e) {
                ...
                var m, h, w, b, C, x, y = v + e, T = p + "-" + y, F = i[e], I = a.slug(F.name), E = (F.size || 0) / 1e3,
                    k = "", $ = Q.createObjectURL(F), P = 0, S = a.allowedFileTypes, D = W(S) ? "" : S.join(", "),
                ...
                if (!W(S) && q(S)) {
                    for (w = 0; w < S.length; w += 1) C = S[w], h = f[C], x = void 0 !== h && h(F.type, I), P += W(x) ? 0 : x.length;
                    if (0 === P) return b = a.msgInvalidFileType.replace("{name}", I).replace("{types}", D), void(a.isError = g(b, F, T, e))
                }
                return 0 !== P || W(U) || !q(U) || W(k) || (x = I.match(k), P += W(x) ? 0 : x.length, 0 !== P) ? a.showPreview ? (n.length > 0 && void 0 !== FileReader ? (s.html(d.replace("{index}", e + 1).replace("{files}", u)), o.addClass("file-thumb-loading"), l.onerror = function (e) {
                    a.errorHandler(e, I)
                }, l.onload = function (i) {
                    a.previewFile(e, F, i, T, $), a.initFileActions()
                ...
                }, 100), a.raise("fileloaded", [F, T, e, l])), void a.addToStack(F)) : (a.addToStack(F), setTimeout(t(e + 1), 100), void a.raise("fileloaded", [F, T, e, l])) : (b = a.msgInvalidFileExtension.replace("{name}", I).replace("{extensions}", A), void(a.isError = g(b, F, T, e)))
            }, t(0), a.updateFileDetails(u, !1)
        }, updateFileDetails: function (e) {
            var i = this, t = i.$element, a = i.getFileStack(), n = t[0].files[0].name || a.length && a[0].name || "",
            ...
            var n, l, o, s, d, c, p = arguments.length > 1, u = t.isUploadable, f = 0,
                v = p ? i.originalEvent.dataTransfer.files : a.get(0).files, g = t.filestack.length,
                m = W(a.attr("multiple")), h = m && g > 0, w = 0, b = function (i, a, r, n) {
            ...
            if (t.reader = null, t.resetUpload(), t.hideFileIcon(), t.isUploadable && t.$container.find(".file-drop-zone ." + t.dropZoneTitleClass).remove(), p) for (n = []; v[f];) s = v[f], s.type || s.size % 4096 !== 0 ? n.push(s) : w++, f++; else n = void 0 === i.target.files ? i.target && i.target.value ? [{name: i.target.value.replace(/^.+\\/, "")}] : [] : i.target.files;
            if (W(n) || 0 === n.length) return u || t.clear(), t.showFolderError(w), void t.raise("fileselectnone");
            if (t.resetErrors(), c = n.length, o = t.isUploadable ? t.getFileStack().length + c : c, o = t.getFileCount(o), t.maxFileCount > 0 && o > t.maxFileCount) {
                ...
                o > t.maxFileCount && t.resetPreviewThumbs(u)
            } else !u || h ? (t.resetPreviewThumbs(!1), h && t.clearStack()) : !u || 0 !== g || r.count(t.id) && !t.overwriteInitial || t.resetPreviewThumbs(!0);
            t.isPreviewable ? t.readFiles(n) : t.updateFileDetails(1), t.showFolderError(w)
            ...
            !W(f) && t.length && (d = t[0], s = "Width" === n ? d.naturalWidth || d.width : d.naturalHeight || d.height, c = "Small" === i ? s >= f : f >= s, c || (o = p["msgImage" + n + i].replace("{name}", r).replace("{size}", f), p.showUploadError(o, l), p.setPreviewError(a, e, null)))
        ...
        if (l() || i(9)) {
            ...
            switch (a.shift(), this.each(function () {
                ...
                l || ("en" === s || W(e.fn.fileinputLocales[s]) || (d = e.fn.fileinputLocales[s]), i = e.extend(!0, {}, e.fn.fileinput.defaults, e.fn.fileinputLocales.en, d, o, n.data()), l = new Y(this, i), n.data("fileinput", l)), "string" == typeof t && r.push(l[t].apply(l, a))
            }), r.length) {
                case 0:
                    return this;
                case 1:
    ...
    }, e.fn.fileinput.Constructor = Y, e(document).ready(function () {
